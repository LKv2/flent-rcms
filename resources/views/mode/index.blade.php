<x-app-layout>
    <x-slot name="header">
        ...
        <div class="flex items-center space-x-3 w-full md:w-auto">
            ...
            <button id="filterDropdownmodeButton" data-dropdown-toggle="filterDropdownmode"
            ...
            <div id="filterDropdownmode"
                class="z-10 hidden w-48 p-3 bg-white rounded-lg shadow dark:bg-gray-700">
                <h6 class="mb-3 text-sm font-medium text-gray-900 dark:text-white">
                    {{ __('marque') }}</h6>
                <ul class="space-y-2 text-sm" aria-labelledby="filterDropdownmodeButton">
                    @foreach ($marques as $marque)
                        <li class="flex items-center">
                            <input id="{{ $marque->id }}" type="checkbox"
                                value="{{ $marque->id }}"
