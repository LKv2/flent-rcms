    ...
    <x-slot name="header">
        ...
        <div class="flex items-center space-x-3 w-full md:w-auto">
            <select name="etat" id="etatDropdown"
                ...
                <option value="all">{{ __('content.All') }}</option>
                ...
                <table id="car-table" class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            ...
                            <th scope="col" class="px-4 py-3">{{ __('etat.name') }}</th>
                            <th scope="col" class="px-4 py-3">{{ __('status.name') }}</th>
                                    ...
                                    <div id="{{ $car->nrchassis }}"
                                        ...
                                        <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                            ...
                                            <li>
                                                ...
                                                <a data-modal-target="EiditeCar{{ $car->id }}"
                                                    data-modal-toggle="EiditeCar{{ $car->id }}"
