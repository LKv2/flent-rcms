...
<div id="AddDevice" tabindex="-1" aria-hidden="true"
    class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full" style="z-index: 1000">
    <div class="relative w-full max-w-2xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-6 space-y-6">
                <form action="{{ route('gps.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-6 ">
                    ...
                    <div class="mb-6">
                        <label for="GPSCode" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                            Identifiant</label>
                        <input type="text" name="GPSCode" id="GPSCode">
                    </div>
                    <div class="mb-6">
                        <label for="phoneGPS" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                            Gps Phone</label>
                        <input type="tel" name="phoneGPS" id="phoneGPS">
                    </div>
                    <div
                        class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                        <button data-modal-hide="AddDevice" type="submit"
                            class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            Ajouter</button>
                        <button data-modal-hide="AddDevice" type="button"
