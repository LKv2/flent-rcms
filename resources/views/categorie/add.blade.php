<!-- Modal toggle -->
<button data-modal-target="AddCategorie" data-modal-toggle="AddCategorie"
...
<!-- Main modal -->
<div id="AddCategorie" tabindex="-1" aria-hidden="true"
            ...
            <div class="p-6 space-y-6">
                <form action="{{ route('categories.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                        <button data-modal-hide="AddCategorie" type="submit" 
                            class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                            {{ __('Add') }}</button>
                        <button data-modal-hide="AddCategorie" type="button"
